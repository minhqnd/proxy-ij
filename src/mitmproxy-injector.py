...
INJECT_HTML = '<div id="injected-banner" style="position:fixed;right:12px;bottom:12px;padding:8px;background:#0b74de;color:#fff;border-radius:6px;z-index:2147483647">INJECTED</div>'
INJECT_SCRIPT = "alert('injected script');"
INJECT_SELECTOR = "body"  # CSS selector to append snippet into; fallback to body
